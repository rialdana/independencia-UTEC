...
public class CountriesActivity extends AppCompatActivity implements CountriesListener {
    ...
    private ArrayList<Country> createAllCountries() {
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Torogoz", "https://upload.wikimedia.org/wikipedia/commons/9/9e/Motmot1.jpg"),
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Quetzal (Pharomacrus mocinno)", "https://upload.wikimedia.org/wikipedia/commons/9/9f/Quetzal4.jpg"),
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Tucán de Quilla o Picoiris (Ramphastos Solfurantus)", "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Toucan_edit_%288540775223%29.jpg/442px-Toucan_edit_%288540775223%29.jpg"),
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Lapa Roja (Ara macao)", "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Scarlet_Macaw_%28Ara_macao%29_-raising_leg.jpg/800px-Scarlet_Macaw_%28Ara_macao%29_-raising_leg.jpg"),
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Guardabarranco (Eumomota superciliosa)", "https://upload.wikimedia.org/wikipedia/commons/9/9e/Motmot1.jpg"),
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Yigüirro o Cenzontle de Agua (Turdus grayi)", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Clay-colored_Thrush_%28Turdus_grayi%29.jpg/800px-Clay-colored_Thrush_%28Turdus_grayi%29.jpg"),
        ...
        countries.add(new Country(
                ...
                new NationalSymbol("Águila Arpía", "https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Harpyia.jpg/406px-Harpyia.jpg"),
